...
$(function () {
//contribuciones
  var contribuciones = JSON.parse($('#contribucionesHiddenPrf').text());
...
//estadisticas
 ...
 var estadisticas = JSON.parse($('#estadisticasHiddenPrf').text());
 ...
 $('#notaMediaPerfilPrf').text(notaMedia.toFixed(2));
 ...
 statChartsPrf();
  ...
  function contrChartsPrf() {
      /*var ctx = $("#barChart").get(0).getContext("2d");
          barChart = new Chart(ctx).Bar(barChartData, barChartOptions);;*/
      /* ChartJS
    * -------
    ...
    */
      ...
      */
      ...
      //-------------
      // Get context with jQuery - using jQuery's .get() method.
      var pieChartCanvas = $("#contrPieChartPrf").get(0).getContext("2d");
  ...
  function statChartsPrf() {
    ...
    var barChartCanvas = $("#statBarChartPrf").get(0).getContext("2d");
    var barChart = new Chart(barChartCanvas);
